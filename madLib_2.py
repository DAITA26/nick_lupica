...
name = input("Dimmi un nome ").capitalize()
if not name.isalpha():  # se il nome non contiene solo lettere riporta errore
    print("Errore: il nome può contenere solo lettere.")
place = input("Dimmi il nome di un luogo ").lower()
fruit= input("Dimmi un frutto ")
number = float(input("Dimmi un numero "))
number_2 = float(input("Dimmi un altro numero "))
